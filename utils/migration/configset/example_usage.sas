...
%macro setup();
%let core_root_path=%sysget(SAS_RISK_CIRRUS_CODE_LIB_SHARED_DIR);
%let core_code_path=&core_root_path./core/code_libraries/release-core-%sysget(SAS_RISK_CIRRUS_CADENCE);
