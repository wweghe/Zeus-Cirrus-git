...
class ObjectRegistrationService:
    ...
    __STATE_KEY_OBJECT_REGISTRATIONS : str = "object_registrations"
    __STATE_KEY_OBJECT_REST_PATHS : str = "object_registration_rest_paths"
    ...
    def get_object_registration(self, 
        ...
        try:
            registrations : Dict[str, SimpleNamespace] = self._state.get(self.__STATE_KEY_OBJECT_REGISTRATIONS, {})
            ...
            if (object_registration is None):
                ...
                if (reg_list is None or len(reg_list) == 0):
                    ...
                    self._state.update(self.__STATE_KEY_OBJECT_REGISTRATIONS, registrations)
        finally:
            self._state.unlock()
    ...
    def get_all_object_registration_rest_paths(self) -> List[str]:
        ...
        try:
            rest_paths = self._state.get(self.__STATE_KEY_OBJECT_REST_PATHS, None)
            ...
            if (rest_paths is None):
                ...
                self._state.update(self.__STATE_KEY_OBJECT_REST_PATHS, rest_paths)
        finally:
            self._state.unlock()
