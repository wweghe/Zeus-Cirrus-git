...
class BaseRepository:
    ...
    def __init__(self, 
                 ...
                 return_type : Any = SimpleNamespace,
        ...
        if (return_type is None and return_conversion_func is None): raise ValueError(f"return_type and return_conversion_func cannot be empty")
        ...
        self._return_conversion_func = return_conversion_func
    ...
    def get_by_filter(self, 
        ...
        if (sort_by is not None and len(str(filter)) > 0):
            query_params.update({ "sortBy": ','.join(sort_by) })
