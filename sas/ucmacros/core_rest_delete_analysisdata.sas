...
/**
   \file 
\anchor core_rest_delete_analysisdata

   \brief   Delete an analysis data instance in SAS Risk Cirrus objects
   ...
   \details
   This macro sends a DELETE request to <b><i>\<host\>:\<port\>/riskData/objects/analysisData/</i></b> and collects the results in the output table. \n
   ...
   \code
      %let accessToken =;
      %core_rest_delete_analysisdata(host = <host>
                                      , port = <port>
                                      , server = riskData
                                      , username =
                                      , password =
   ...
   \date    2023
*/
%macro core_rest_delete_analysisdata(host =
                                      , port =
                                      , server = riskData
                                      , logonHost =
                                      , logonPort =
   ...
   %let requestUrl = &baseUrl./&server./objects/&key.;
...
%mend core_rest_delete_analysisdata;