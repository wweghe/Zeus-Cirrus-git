...
\anchor core_rest_get_cycle
   ...
   | key                                  | sourceSystemCd | statusCd | objectId   | baseDttm                 | name       | createdInTag |
   |--------------------------------------|----------------|----------|------------|--------------------------|------------|--------------|
   | 0d290c4c-234e-4238-a575-7b5b76430778 | RCC            | CREATED  | cycle_2018 | 2018-12-31T08:06:52.420Z | cycle_2018 | ECL          | 
