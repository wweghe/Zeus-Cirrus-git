%macro core_rest_export_rsm_scen_set(host =
   ...
   data &outScenarioSetDs.;
      merge &outScenarioSetDs. scenario_summary (keep=id periodType forecastTime rename=(id=scenarioId));
      by scenarioId;
   run;
   ...
   %core_rest_export_rsm_scenario(host =
                                 ...
                                 , outScenariosFilePath = &outScenariosFilePath.
                                 , outScenariosFile = &outScenariosFile.
