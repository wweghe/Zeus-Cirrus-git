...
\anchor core_rest_import_scenarios
   ...
   <b>Sample input excel spreadsheets scenarios data. </b>

   |    date    |  AsOfDate  |  shock_factor  | <risk factor 1> | <risk factor 2> | <risk factor ...> | <risk factor n> |
   |------------|------------|----------------|-----------------|-----------------|-------------------|-----------------|
   | 2021-12-31 | 2021-12-31 |        1       | <numeric value> | <numeric value> |  <numeric value>  | <numeric value> |

   <b>Sample input excel spreadsheets for scenario __history__. </b>

   |    date    |  AsOfDate  |  shock_factor  | <risk factor 1> | <risk factor 2> | <risk factor ...> | <risk factor n> |
   |------------|------------|----------------|-----------------|-----------------|-------------------|-----------------|
   | 1983-09-30 | 2021-12-31 |        1       | <numeric value> | <numeric value> |  <numeric value>  | <numeric value> |

   <b>Sample input excel spreadsheets for scenarioSet. </b>
...
%macro core_rest_import_scenarios(host =
   ...
   %local
      listScenariosId listScenariosName listScenariosWeight
   ;
