...
/**
   \file
\anchor core_rest_get_rsm_scen_summary

   \brief   Retrieve a scenario summary registered in SAS Risk Scenario Manager
   ...
   \code
  %let accessToken =;
  %core_rest_get_rsm_scen_summary(id = f5cbf66a-1b06-4df7-914e-f108ae9c80a8
                              , outds = scenario_set
                              , debug = true
   ...
   \date    2022
*/
%macro core_rest_get_rsm_scen_summary(host =
   ...
   %core_rest_request(url = &requestUrl.
                     ...
                     , parser = sas.risk.rsm.rsm_rest_parser.rsmRestScenarioFull
                     , outds = &outds.
   ...
   %if(not &&&outSuccess..) %then %do;
      %put ERROR: Unable to get the scenario summary;
