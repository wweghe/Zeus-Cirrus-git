%macro corew_process_bep(solution =
   ...
   %local   outCasLibref
            ...
            portSchemaName portSchemaVersion found_configuration_flag;
   ...
   */
   %if &gen_table_exists. or &elim_table_exists. %then %do;
      ...
      data  &outCasLibref..&outGeneratedPositions. (drop=__rc__ scenarioName _inst_scenario_name_orig_ _inst_scenario_ft_orig_ i _lastEffectiveDate_)
         ...
         /* add interval type value for forecas period calculation in report*/
   ...
   data work.datastore_config_override;
      ...
      schemaName="&portSchemaName._BEP_SYNTH";
      schemaVersion="&portSchemaVersion.";
      sourceLibref="&outCasLib.";
      targetTableName="&outGeneratedPositions.";
      dataDefinitionName="ST BEP Synthetic Instrument Definition (&portSchemaName._&portSchemaVersion.)";
      dataDefinitionDesc="ST BEP Synthetic Instrument Definition (&portSchemaName._&portSchemaVersion.)";
