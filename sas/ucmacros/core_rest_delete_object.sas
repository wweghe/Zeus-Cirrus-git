...
/**
   \file 
\anchor core_rest_delete_object
   ...
   \param [in] objectRestPath the object rest path registered in Cirrus Objects (i.e. ruleSets)
   ...
   2) Send a Http DELETE request to delete the specified object at the specified rest path
   \code
      %let accessToken =;
      %core_rest_delete_object(host = <host>
                                      , port = <port>
                                      , server = riskCirrusObjects
                                      , username =
                                      , password =
                                      , key = <key>
                                      , objectRestPath = <objectRestPath>
   ...
   \date    2023
*/
%macro core_rest_delete_object(host =
                             , port =
                             , server = riskCirrusObjects
                             , logonHost =
                             , logonPort =
   ...
   %let requestUrl = &baseUrl./&server./objects/&objectRestPath./&key.;
