         ...
         for i, actionNode in ipairs(pipelineVal) do
            ...
            if (actionNode.type == "query") then
               ...
               if (queryNodeInputs.reHorizons ~= "") then
                  actionNode["horizons"] = {}
                  if (string.upper(queryNodeInputs.reHorizons) ~= "MAX") then
            ...
            --Modify the customers custom code node.  This is separate from the special pre/post custom code nodes we add
